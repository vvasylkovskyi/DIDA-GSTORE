...
namespace DataStoreServer.Util
{
    class Utilities
    {
        ...
        {
            // TODO check what the value of the third argument should be
            Domain.DataStoreKey domain_key = new Domain.DataStoreKey(dto_key.PartitionId, dto_key.ObjectId, true);
            return domain_key;
        }
